...
<head>
    ...
    <!-- The fav icon -->
    <link rel="shortcut icon" href="img/avion1.png">
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index_admin">
                <span>Agencia Admin</span>    
            </a>

            <!-- user dropdown starts -->
            <div class="btn-group pull-right">
                <a class="btn btn-default dropdown-toggle" href="administrar" >
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li requered autofocus><a class="ajax-link" href="/"><i class="glyphicon glyphicon-home"></i><span> Inicio</span></a>
                        </li>
                        <li requered autofocus><a class="ajax-link" href="administrar"><i class="glyphicon glyphicon-home"></i><span> Administrar</span></a>
                        </li>
