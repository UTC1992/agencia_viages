function validarformulario(){
	var ced=document.adminData.cedula.value; 
		if (ced==""){
	...
	var nom=document.adminData.nombre.value;
			if (nom=="" )
			{
	...
	var ape=document.adminData.apellido.value;
		if (ape=="" )
		{
	...
	var tlf=document.adminData.telefono.value; 
		if (tlf=="")
		{
	...
	var cel=document.adminData.celular.value; 
		if (cel=="")
		{
	...
	var ciu=document.adminData.ciudad.value;
			if (ciu=="" )
			{
				alert("Ingrese la ciudad");
				return false;
			}
	var dir=document.adminData.direccion.value;
			if (dir=="" )
			{
				alert("Ingrese su dirección");
				return false;
			}
	var pass=document.adminData.password.value;
			if (pass=="" )
			{
